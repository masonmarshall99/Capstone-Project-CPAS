...
class DiseasePresence(models.Model):
    ...
    crop = models.ForeignKey(Crops, on_delete=models.PROTECT)
    sub_region = models.ForeignKey(Location, on_delete=models.PROTECT)
    disease_presence_status = models.CharField(max_length=1)
    disease_incidence_year_percentage = models.FloatField()
    disease_incidence_area_percentage = models.FloatField()
    disease_severity_without_control_percentage = models.FloatField()
    disease_severity_with_control_percentage = models.FloatField()
    disease_severity_control_genetic_contribution_percentage = models.FloatField()
    disease_severity_control_cultural_contribution_percentage = models.FloatField()
    disease_severity_control_pesticide_contribution_percentage = models.FloatField()
